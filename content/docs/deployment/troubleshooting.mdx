...
5. If release security artifacts are missing or `policy-result.json` reports a failed policy decision, pause the update and collect the release notes, metadata response, and updater log for support/security review.
