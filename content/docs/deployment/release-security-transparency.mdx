...
Waivers require a CVE or vulnerability ID, owner, rationale, expiry, and compensating controls. Expired waivers fail the release. A waiver without a clear owner, reason, expiry date, and mitigation is not acceptable release evidence.
