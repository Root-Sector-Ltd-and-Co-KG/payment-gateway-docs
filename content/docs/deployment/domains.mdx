...
> [!IMPORTANT]
> Custom domains are frequently part of payment-provider compliance, not just branding. Providers may require your checkout pages, callback URLs, and webhook endpoints to remain on domains you own and control.
