...
Published product releases can include auditable security artifacts tied to the same product version used by release notes and deployment metadata. These artifacts help operators understand what was shipped and what was scanned.

### Security Scan Matrix

| Artifact | Purpose |
| --- | --- |
| SBOM | Provides a dependency and component inventory for the released version. |
| Vulnerability report | Summarizes known vulnerability findings reviewed for the released version. |
| Scan manifest | Ties published security artifacts to the product release version and deployment metadata. |
