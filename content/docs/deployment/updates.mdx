...
Sometimes you only need to update a single microservice (e.g., `admin-backend` or `main-worker`) without a full redeployment. The system supports targeted service updates:
