...
6. If an organization configures cloud storage, S3, Azure, or GCS, PDFs are stored there permanently; otherwise the temporary worker cache is the delivery source.
