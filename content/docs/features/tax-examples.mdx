...
> [!NOTE]
> Screenshot placeholder: **Settings > Tax** overview showing seller country, VAT ID, price mode, rounding method, and OSS/VIES toggles.
...
> [!NOTE]
> Screenshot placeholder: **Settings > Checkout** showing `vatIdValidation = vies` and tax breakdown display enabled.
...
> [!NOTE]
> Screenshot placeholder: **Tax Rules** list showing generated OSS destination rules and priorities.
...
> [!NOTE]
> Screenshot placeholder: **VAT OSS report** showing source filter, quarter selector, country breakdown, and export buttons.

> [!NOTE]
> Screenshot placeholder: **Invoice detail** showing linked transaction, credit notes, tax summary, and PDF/XML download actions.
