...
> [!NOTE]
> Screenshot placeholder: **Invoice detail** showing Seller, Client, document status, payment state, tax summary, PDF/XML downloads, and linked transaction.
...
> [!NOTE]
> Screenshot placeholder: **Settings > Templates > Document Templates** showing default template selection, preview, duplicate, and assignment controls.
