...
See [Recurring Schedules](./recurring) for operator-side schedule behavior and [Main Backend Public Endpoints](../api-reference/main-api) for the portal API surface.
...
- Customers can optionally provide a cancellation reason. The gateway stores a trimmed reason for operator records and caps it at 500 characters.
