...
2.  **Tax Rules**: Connect a Rate to a demographic. You define rules like _"If Seller=DE and Buyer=Any EU Country, and the item is a Digital Service, apply the Buyer's local rate (OSS)"_.
