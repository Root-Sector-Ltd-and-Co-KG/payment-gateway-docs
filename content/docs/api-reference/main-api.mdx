...
Peppol portal downloads use the seller and buyer Peppol routing addresses stored on the invoice or credit-note snapshot. XRechnung and ZUGFeRD do not require Peppol routing addresses. If a Peppol snapshot is missing or invalid, fix the organization/client setup for future documents and use the admin invoice correction workflow for already issued documents.
