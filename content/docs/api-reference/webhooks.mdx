...
Webhook authenticity and idempotency are part of the payment-data evidence boundary. See [Payment Data Boundary](../deployment/payment-data-boundary) for the customer-facing evidence status and residual responsibilities.
